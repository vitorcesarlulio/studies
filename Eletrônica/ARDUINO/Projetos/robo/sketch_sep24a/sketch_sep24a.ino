...
void loop() {
  ...
  if (Distancia < 46) {                             // Se há obstáculo encontrado a menos de 40cm. // DA PRA COLOCAR MENOS
   direcao ();                                      // Se Frente estiver bloqueado, mude de direção
  }
  else if (Distancia >= 46)  {                      // Se o obstáculo for encontrado entre a mais de 40cm 
